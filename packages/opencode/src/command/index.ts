  ...
  Effect.gen(function* () {
    ...
    const init = Effect.fn("Command.state")(function* (ctx: InstanceContext) {
      ...
      commands[Default.DIFF] = {
        name: Default.DIFF,
        description: "summarize and explain current changes (or a commit/range)",
        source: "command",
        get template() {
          return PROMPT_DIFF
        },
        hints: hints(PROMPT_DIFF),
      }
      ...
      commands[Default.EXPLAIN] = {
        ...
        description: "explain a file, function, or concept in this codebase",
        source: "command",
        get template() {

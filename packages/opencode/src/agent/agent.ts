      ...
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          coordinator: {
            name: "coordinator",
            description:
              "Orchestrator mode. Biased toward decomposing work and delegating research/implementation/verification to parallel sub-agents via the task tool, then synthesizing results.",
            permission: Permission.merge(
              defaults,
              Permission.fromConfig({
                question: "allow",

            ...
            <div class="flex items-center gap-2">
              ...
              <div class="flex items-center gap-1">
                ...
                <div class="hidden md:flex items-center gap-1 shrink-0">
                  ...
                  <TooltipKeybind
                    title={language.t("command.chat.toggle")}
                    keybind={command.keybind("chat.toggle")}
                  >
                    <Button
                      variant="ghost"
                      class="titlebar-icon w-8 h-6 p-0 box-border"
                      onClick={() => layout.chat.toggle()}
                      aria-label={language.t("command.chat.toggle")}
                      aria-expanded={layout.chat.opened()}
                    >
                      <Icon
                        size="small"
                        name="prompt"
                        classList={{
                          "text-icon-strong": layout.chat.opened(),
                          "text-icon-weak": !layout.chat.opened(),
                        }}
                      />
                    </Button>
                  </TooltipKeybind>
